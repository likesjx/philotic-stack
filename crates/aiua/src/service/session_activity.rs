...
/// correlation value either way. Complements `is_turn_tail_action`, which
/// gates by ACTION (tail envelopes of real turns); this gates by IDENTITY
/// (dispatch kinds that must never be turns at all).
