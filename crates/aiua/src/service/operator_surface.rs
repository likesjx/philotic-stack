...
use philotic_client::{
    ComponentInventoryEntryView, DesktopMembraneTargetGuestInventoryView,
    DesktopMembraneTargetStatusView, GuestIdentity, IpcRequest, IpcResponse,
    ...
    OperatorTargetConfigMutationAckView, OperatorTargetConfigView, OperatorTargetGuestInventoryView,
    OperatorTargetPlacementView, OperatorTargetRoleHomeAckView, OperatorTargetSecretEntryView,
...
impl IpcServer {
    ...
    pub(super) async fn query_remote_desktop_membrane_guests(
        graph: &GraphDomain,
        local_node_id: &str,
        target_node_id: &str,
        target_hotel: &str,
    ...
    pub(super) async fn query_remote_desktop_membrane_status(
        graph: &GraphDomain,
        local_node_id: &str,
        target_node_id: &str,
        target_hotel: &str,
