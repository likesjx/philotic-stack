...
| Mesh and Placement | [architecture/INTER_HOTEL_ROUTING_PROPOSAL.md](architecture/INTER_HOTEL_ROUTING_PROPOSAL.md), [architecture/NATIVE_OVERLAY_VPN_PROPOSAL.md](architecture/NATIVE_OVERLAY_VPN_PROPOSAL.md), [architecture/MULTI_HOTEL_COMPONENT_DISTRIBUTION_PROPOSAL.md](architecture/MULTI_HOTEL_COMPONENT_DISTRIBUTION_PROPOSAL.md), [architecture/RELOCATION_CEREMONY_PROPOSAL.md](architecture/RELOCATION_CEREMONY_PROPOSAL.md) |
