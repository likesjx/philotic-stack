...
| `membrane-transport-home` | `membrane-transport` | MEMBRANE_TRANSPORT_HOME_PROPOSAL (intel-graph), [RELOCATION_CEREMONY_PROPOSAL.md](/Users/jaredlikes/code/philotic-stack/docs/architecture/RELOCATION_CEREMONY_PROPOSAL.md) (R1/R2) | test-green (Telegram) | `docs/task.md` → `New Project: Multi-Hotel Component Distribution` |
...
| `relocation-ceremony` | `mesh-placement` | [RELOCATION_CEREMONY_PROPOSAL.md](/Users/jaredlikes/code/philotic-stack/docs/architecture/RELOCATION_CEREMONY_PROPOSAL.md) | accepted-current-slice | `docs/task.md` → `New Project: Agent-Initiated Relocation` |
| `graph-truth-over-seed` | `mesh-placement` | [RELOCATION_CEREMONY_PROPOSAL.md](/Users/jaredlikes/code/philotic-stack/docs/architecture/RELOCATION_CEREMONY_PROPOSAL.md) | test-green | `docs/task.md` → `New Project: Agent-Initiated Relocation` (R1) |
...
| `tool-management-plane-records` | `tooling-execution` | [TOOL_MANAGEMENT_PLANE_PROPOSAL.md](/Users/jaredlikes/code/philotic-stack/docs/architecture/TOOL_MANAGEMENT_PLANE_PROPOSAL.md) | `docs/task.md` → `Next Project: Tool Assembly and Routed Execution` (T1 2026-09-16: `catalog/tools.yaml` → `abstract_tool` records → philote registry; `batch_of`) |
...
| `memory-engine-contract` | `memory-context` | [archive/MEMORY_ENGINE_ABSTRACTION_PROPOSAL.md](/Users/jaredlikes/code/philotic-stack/docs/architecture/archive/MEMORY_ENGINE_ABSTRACTION_PROPOSAL.md) | retired — proposal obsolete/archived; the contract shipped as `memory-core` (`MuninnRestEngine` + `NullMemoryEngine`). Successor surface: [MUNINN_MEMORY_PROTOCOL_PROPOSAL.md](/Users/jaredlikes/code/philotic-stack/docs/architecture/MUNINN_MEMORY_PROTOCOL_PROPOSAL.md) |
| `graph-muninn-memory-dual-path` | `memory-context` | [archive/MEMORY_ENGINE_ABSTRACTION_PROPOSAL.md](/Users/jaredlikes/code/philotic-stack/docs/architecture/archive/MEMORY_ENGINE_ABSTRACTION_PROPOSAL.md) | retired — proposal obsolete/archived; the dual-path question is superseded by the three-plane split in [KNOWLEDGE_ARCHITECTURE_PROPOSAL.md](/Users/jaredlikes/code/philotic-stack/docs/architecture/KNOWLEDGE_ARCHITECTURE_PROPOSAL.md) (see ARCHITECTURE.md §10.6) |
