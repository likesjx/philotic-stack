...
- [ ] Wire the actual Gemini Live session transport on that seam: WebSocket lifecycle, `send_realtime_input`, partial audio/text event mapping, sequential tool-response continuation, and session-resumption markers.
