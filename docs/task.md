...
- [x] Add typed placement markers (`marker_kind`, `marker_source`) to runtime provenance so transport continuity, handoff, membrane ingress, and later routing enzymes can be distinguished instead of all staining the same way.
