...
- [ ] Reclassify same-self `handoff.to_role` / `handoff.back` out of the generic high-risk bucket and let remembered role-shift patterns become a lower-friction workflow reflex when authority and rights do not widen.
