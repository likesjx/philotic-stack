...
REQUIRED_DOCS = {
    ...
    "docs/architecture/CREATIVE_LEARNING_FLYWHEEL_PROPOSAL.md": PROPOSAL_KEYS,
    ...
    "docs/architecture/KNOWLEDGE_ARCHITECTURE_PROPOSAL.md": PROPOSAL_KEYS,
    "docs/architecture/LOCAL_ADMIN_FALLBACK_MODEL_PROPOSAL.md": PROPOSAL_KEYS,
    "docs/architecture/MEMPALACE_EPISODIC_MEMORY_PROPOSAL.md": PROPOSAL_KEYS,
    ...
    "docs/architecture/OBSIDIAN_KNOWLEDGE_GARDEN_PROPOSAL.md": PROPOSAL_KEYS,
